...
# from langchain_community.chat_models import ChatAnthropic, ChatFriendli
...
# frindli = ChatAnthropic(temperature=0.5,
...
#     repo_id="google/flan-t5-small",  # A lightweight summarization model
